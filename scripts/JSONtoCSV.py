...
fout.write("data,denominazione_regione,dosi_somministrate,dosi_consegnate,percentuale_dosi_somministrate_su_consegnate\n")
for el in data:
    fout.write(time+","+el[0]+","+str(el[1])+","+str(el[3])+","+str(round(float(el[2])*100,2))+"\n")
fout.close()
